...
// Define o formato dos posts usados pela pagina criada a partir do layout do Figma Make.
type BlogPost = {
   title: string
   description: string
   date: string
...
// Mantem as categorias centralizadas para alimentar os filtros e evitar textos repetidos no template.
const categories = [
   'Todos',
   'Automacao Portuaria',
   'CMS',
...
// Replica os dados gerados pelo Figma Make em uma estrutura simples para renderizar os cards.
const blogPosts: BlogPost[] = [
   {
      title: 'Edicao editorial com Pages CMS',
      description:
         'Como o Pages CMS entra como camada de edicao para arquivos Markdown do proprio repositorio.',
      date: '18 abr 2026',
      tags: ['CMS', 'Conteudo', 'Git'],
      image: '/images/blog-cover-cms.svg',
      link: '/blog/pages-cms-e-editorial'
   },
   {
      title: 'Integracao de sistemas portuarios via API',
      description:
         'Descubra como integrar diferentes sistemas de gestao portuaria usando APIs REST modernas e seguras.',
      date: '10 maio 2026',
      tags: ['Tecnologia', 'Automacao Portuaria'],
      image:
         'https://images.unsplash.com/photo-1634638021403-70f46d19fc02?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      link: '/blog/pages-cms-e-editorial'
   },
   {
      title: 'Monitoramento em tempo real: dashboards eficientes',
      description:
         'Aprenda a construir dashboards que oferecem visibilidade completa da operacao portuaria em tempo real.',
      date: '05 maio 2026',
      tags: ['Tecnologia', 'Logistica'],
      image:
         'https://images.unsplash.com/photo-1634638026221-4c1c4cf9f881?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      link: '/blog/pages-cms-e-editorial'
   },
   {
      title: 'Git workflow para equipes de operacao',
      description:
         'Praticas recomendadas de versionamento e colaboracao usando Git em ambientes de operacao critica.',
      date: '28 abr 2026',
      tags: ['Git', 'CMS'],
      image: '/images/blog-cover-static-site.svg',
      link: '/blog/pages-cms-e-editorial'
   },
   {
      title: 'Otimizacao de rotas logisticas com IA',
      description:
         'Como algoritmos de inteligencia artificial estao revolucionando o planejamento de rotas e reduzindo custos.',
      date: '22 abr 2026',
      tags: ['Logistica', 'Tecnologia'],
      image:
         'https://images.unsplash.com/photo-1775851607186-b5b409680dde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      link: '/blog/pages-cms-e-editorial'
   },
   {
      title: 'Seguranca cibernetica em ambientes portuarios',
      description:
         'Estrategias essenciais para proteger infraestruturas criticas de portos contra ameacas digitais.',
      date: '15 abr 2026',
      tags: ['Tecnologia', 'Automacao Portuaria'],
      image:
         'https://images.unsplash.com/photo-1575659102796-ef180602a75d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      link: '/blog/pages-cms-e-editorial'
   }
]

// Destaca um conteudo fixo acima da listagem para seguir a composicao proposta pelo Figma Make.
const featuredPost: BlogPost = {
   title: 'O futuro da automacao portuaria: IA e IoT na gestao de terminais',
   description:
      'Descubra como a combinacao de Inteligencia Artificial e Internet das Coisas esta revolucionando a gestao de terminais portuarios, aumentando a eficiencia operacional e reduzindo custos em ate 40%.',
   date: '12 maio 2026',
   tags: ['Automacao Portuaria', 'Tecnologia'],
   image: '/images/bg_iport_video.png',
   link: '/blog/pages-cms-e-editorial'
}

// Calcula os posts visiveis conforme o filtro selecionado pelo usuario.
const filteredPosts = computed(() => {
   if (activeCategory.value === 'Todos') return blogPosts
...
// Configura os metadados da pagina alternativa sem alterar o SEO da rota /blog principal.
useSeoMeta({
   title: 'Blog iPORT Solutions - Layout Figma Make',
   description:
      'Pagina alternativa do blog iPORT Solutions baseada no layout criado pelo Figma Make.',
...
<template>
   <div class="blog-page">
      ...
      <!-- Footer institucional simples para fechar a pagina sem depender de componentes globais. -->
      <footer class="blog-footer">
         <div class="blog-container blog-footer__inner">
            ...
            <div class="blog-footer__links">
               ...
               <NuxtLink to="/blog">Blog atual</NuxtLink>
...
/* Footer separado para esta pagina experimental. */
.blog-footer {
   padding: 32px 0;
   background: #00204a;
}
